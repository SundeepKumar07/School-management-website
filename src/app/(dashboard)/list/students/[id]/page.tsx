        ...
        <div className='flex justify-between flex-col lg:flex-row gap-2'>
          ...
          <div className='flex gap-4 w-full lg:w-2/3 bg-[#f4f7ff] rounded-lg'>
            <div className='w-1/3 flex justify-center items-center py-2'>
              <Image src={`https://images.pexels.com/photos/1187765/pexels-photo-1187765.jpeg?auto=compress&cs=tinysrgb&w=1200`} alt='photo' width={144} height={144} className='w-35 h-35 rounded-full' />
            </div>
          ...
          <div className='w-full lg:w-1/3 grid grid-cols-1 sm:grid-cols-2 gap-2'>
            ...
            <div className='flex gap-2 bg-white py-2 items-center rounded-md'>
              ...
              <div className=''>
                <p className='text-xl text-gray-800 font-semibold'>6th</p>
            ...
            <div className='flex gap-2 bg-white py-2 items-center rounded-md'>
              ...
              <div className=''>
                <p className='text-xl text-gray-800 font-semibold'>6A</p>
      ...
      <div className='w-full md:w-1/3 pl-2'>
        <div className='flex gap-2 flex-col bg-white py-2 px-1'>
          ...
          <div className='flex gap-2 flex-wrap'>
            <Link href={`/list/teachers?teacherId=${1}`} className='text-sm text-gray-500 px-2 py-1 bg-blue-50 cursor-pointer rounded-md'>Student's Teachers</Link>
            <Link href={'/list/lessons'} className='text-sm text-gray-500 px-2 py-1 bg-purple-50 cursor-pointer rounded-md'>Student's Lessons</Link>
            <Link href={'/list/assignments'} className='text-sm text-gray-500 px-2 py-1 bg-red-50 cursor-pointer rounded-md'>Student's Assignmets</Link>
            <Link href={'/list/exams'} className='text-sm text-gray-500 px-2 py-1 bg-yellow-50 cursor-pointer rounded-md'>Student's Exams</Link>
            <Link href={'/list/results'} className='text-sm text-gray-500 px-2 py-1 bg-green-50 cursor-pointer rounded-md'>Student's Results</Link>
          </div>
        </div>
