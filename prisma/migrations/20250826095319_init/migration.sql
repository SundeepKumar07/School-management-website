...
CREATE TABLE "Class" (
    ...
    "gradeId" INTEGER NOT NULL,
    CONSTRAINT "Class_supervisorId_fkey" FOREIGN KEY ("supervisorId") REFERENCES "Teacher" ("id") ON DELETE RESTRICT ON UPDATE CASCADE,
...
CREATE TABLE "Attendence" (
    ...
    "studentId" TEXT NOT NULL,
    "lessonId" INTEGER NOT NULL,
    CONSTRAINT "Attendence_studentId_fkey" FOREIGN KEY ("studentId") REFERENCES "Student" ("id") ON DELETE RESTRICT ON UPDATE CASCADE,
